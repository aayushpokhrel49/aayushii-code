...
use aayushicode_actions::{OpenRecent, OpenRemote};
...
pub fn init(cx: &mut App) {
    #[cfg(target_os = "windows")]
    cx.on_action(|open_wsl: &aayushicode_actions::wsl_actions::OpenFolderInWsl, cx| {
    ...
    #[cfg(target_os = "windows")]
    cx.on_action(|open_wsl: &aayushicode_actions::wsl_actions::OpenWsl, cx| {
        let create_new_window = open_wsl
            .create_new_window
            .unwrap_or_else(|| default_open_in_new_window(cx));
        with_active_or_new_workspace(cx, move |workspace, window, cx| {
