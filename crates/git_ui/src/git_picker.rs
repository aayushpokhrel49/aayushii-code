...
pub fn open_branches(
    ...
    _: &aayushicode_actions::git::Branch,
    window: &mut Window,
...
pub fn register(workspace: &mut Workspace) {
    workspace.register_action(|workspace, _: &aayushicode_actions::git::Branch, window, cx| {
        open_with_tab(workspace, GitPickerTab::Branches, window, cx);
    });
    workspace.register_action(|workspace, _: &aayushicode_actions::git::Switch, window, cx| {
        open_with_tab(workspace, GitPickerTab::Branches, window, cx);
    });
    workspace.register_action(
        |workspace, _: &aayushicode_actions::git::CheckoutBranch, window, cx| {
            open_with_tab(workspace, GitPickerTab::Branches, window, cx);
        },
    );
    workspace.register_action(|workspace, _: &aayushicode_actions::git::ViewStash, window, cx| {
        open_with_tab(workspace, GitPickerTab::Stashes, window, cx);
    });
}
