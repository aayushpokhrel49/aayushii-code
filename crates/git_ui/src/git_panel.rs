...
fn git_panel_context_menu(
    ...
    ContextMenu::build(window, cx, |context_menu, _, _| {
        context_menu
            ...
            .action("View Stash", aayushicode_actions::git::ViewStash.boxed_clone())
                ...
                match (style, is_push) {
                    ...
                    (Toast | ToastWithLog { .. }, true) => {
                        ...
                        this.action("Create Pull Request", move |window, cx| {
                            window
                                .dispatch_action(Box::new(aayushicode_actions::git::CreatePullRequest), cx);
                        })
                    }
                    (Toast, false) => this,
                        ...
                        h_flex()
                            ...
                            .child(
                                div()
                                    ...
                                    .flex_grow_1()
                                    .cursor_text()
                                    .on_action(|&aayushicode_actions::editor::MoveUp, _, cx| {
                                        cx.stop_propagation();
                                    })
                                    .on_action(|&aayushicode_actions::editor::MoveDown, _, cx| {
                                        cx.stop_propagation();
                                    })
...
impl RenderOnce for PanelRepoFooter {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let branch_selector_button = Button::new("branch-selector", branch_name)
            ...
            .truncate(true)
            .on_click(|_, window, cx| {
                window.dispatch_action(aayushicode_actions::git::Switch.boxed_clone(), cx);
            });
        ...
        let branch_selector = PopoverMenu::new("popover-button")
            ...
            .trigger_with_tooltip(
                ...
                Tooltip::for_action_title("Switch Branch", &aayushicode_actions::git::Switch),
            )
            .anchor(Anchor::BottomLeft)
            .offset(gpui::Point {
                x: px(0.0),
