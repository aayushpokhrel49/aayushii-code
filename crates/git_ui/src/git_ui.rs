...
pub fn init(cx: &mut App) {
    ...
    cx.observe_new(|workspace: &mut Workspace, _, cx| {
        ...
        workspace.register_action(
            |workspace, action: &aayushicode_actions::CreateWorktree, window, cx| {
        ...
        workspace.register_action(
            |workspace, action: &aayushicode_actions::SwitchWorktree, window, cx| {
        ...
        workspace.register_action(|workspace, _: &aayushicode_actions::git::Worktree, window, cx| {
        ...
        workspace.register_action(
            |workspace, action: &aayushicode_actions::OpenWorktreeInNewWindow, window, cx| {
        ...
        workspace.register_action(
            |workspace, _: &aayushicode_actions::git::CreatePullRequest, window, cx| {
