...
//! Usual scenario for both cases is opening Zed's settings.json file via `aayushicode: open settings file` command: that starts a language server for a new file open, which originates from a newly created, single file worktree.
//!
