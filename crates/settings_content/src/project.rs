...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in Aayushi Code.
    /// Default: true
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/wu`, worktrees are
    /// created under `~/code/worktrees/wu/`.
    ///
    ...
    /// - `".git/wu-worktrees"` — `<project>/.git/wu-worktrees/`
...
pub struct DiagnosticsSettingsContent {
    ...
    /// Settings for using LSP pull diagnostics mechanism in Aayushi Code.
...
pub struct NodeBinarySettings {
    ...
    pub path: Option<String>,
    /// The path to the npm binary Aayushi Code should use (defaults to `.path/../npm`).
    pub npm_path: Option<String>,
    /// If enabled, Aayushi Code will download its own copy of Node.
    pub ignore_system_version: Option<bool>,
}
