...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in AAYKRA.
    /// Default: true
...
pub struct DiagnosticsSettingsContent {
    ...
    /// Settings for using LSP pull diagnostics mechanism in AAYKRA.
...
pub struct NodeBinarySettings {
    ...
    pub path: Option<String>,
    /// The path to the npm binary AAYKRA should use (defaults to `.path/../npm`).
    pub npm_path: Option<String>,
    /// If enabled, AAYKRA will download its own copy of Node.
    pub ignore_system_version: Option<bool>,
}
