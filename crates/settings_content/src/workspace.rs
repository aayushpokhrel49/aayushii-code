...
pub struct WorkspaceSettingsContent {
    ...
    /// Controls previous session restoration in freshly launched AAYKRA instance.
    ...
    /// Whether to optimize AAYKRA's interface for assistive technology such as
    /// screen readers.
    ///
    /// Default: false
    pub accessible_mode: Option<bool>,
    /// Whether to use the system provided dialogs for Open and Save As.
    /// When set to false, AAYKRA will use the built-in keyboard-first pickers.
    ///
    /// Default: true
    pub use_system_path_prompts: Option<bool>,
    /// Whether to use the system provided prompts.
    /// When set to false, AAYKRA will use the built-in prompts.
    /// Note that this setting has no effect on Linux, where AAYKRA will always
...
<<<<<<< f0ef8c70a37e946424ce654f8d07267111d3233b
    /// Controls whether AAYKRA or the window manager or compositor draws window decorations on Linux.
=======
...
/// Configures what draws AAYKRA's window decorations on Linux.
...
pub enum WindowDecorations {
    /// AAYKRA draws its own window decorations/titlebar (client-side decoration).
    #[default]
    Client,
...
pub enum CliDefaultOpenBehavior {
    /// Open directories as a new workspace in the current AAYKRA window's sidebar.
    #[default]
...
pub enum DefaultOpenBehavior {
    /// Open projects in the current AAYKRA window.
    #[default]
    #[strum(serialize = "Add to Existing Window")]
    ExistingWindow,
...
pub enum RestoreOnStartupBehavior {
    ...
    LastWorkspace,
    /// Restore all workspaces that were open when quitting AAYKRA.
    #[default]
    LastSession,
