...
pub struct SettingsContent {
    ...
    /// This base keymap settings adjusts the default keybindings in AAYKRA to be similar
    /// to other common code editors. By default, AAYKRA's keymap closely follows VSCode's
    ...
    /// Configuration of the terminal in AAYKRA.
...
/// diagnostic data about a running AAYKRA instance.
#[with_fallible_options]
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of AAYKRA's default settings, ignoring user customizations.
    Default,
}
...
pub struct SettingsProfile {
    ...
    /// - `default`: Apply on top of AAYKRA's default settings, ignoring user customizations
    #[serde(default)]
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across AAYKRA sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and AAYKRA
    ///
    /// Default: true
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file AAYKRA had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files AAYKRA had indexed
    Indexed,
