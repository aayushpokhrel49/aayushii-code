...
pub struct KeymapSection {
    ...
    /// documentation](https://code.aayushpokhrel.info.np/docs/key-bindings#contexts) for more details.
    #[serde(default)]
    pub context: String,
        ...
        match KeymapFile::load(
            indoc::indoc! {r#"
                [
                    {
                        "unbind": {
                            "ctrl-a": ["aayushicode::Unbind", "test_keymap_file::StringAction"]
                        }
                    }
                ]
            "#},
            ...
            crate::keymap_file::KeymapFileLoadResult::SomeFailedToLoad {
                ...
                assert!(
                    error_message
                        .0
                        .contains("can't use `\"aayushicode::Unbind\"` as an unbind target.")
                );
            }
            other => panic!("expected SomeFailedToLoad, got {other:?}"),
        }
    ...
    fn keymap_update() {
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                ...
                action_name: "aayushicode::SomeAction",
                context: None,
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                ...
                action_name: "aayushicode::SomeOtherAction",
                context: None,
                action_arguments: None,
            }),
            r#"[
                ...
                {
                    "bindings": {
                        "ctrl-b": "aayushicode::SomeOtherAction"
                    }
                }
            ]"#
            .unindent(),
        ...
        check_keymap_update(
            ...
            r#"[
                ...
                {
                    "bindings": {
                        "ctrl-a": "aayushicode::SomeOtherAction"
                    }
                }
            ]"#
            .unindent(),
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::Replace {
                target: KeybindUpdateTarget {
                    keystrokes: &parse_keystrokes("ctrl-a"),
                    action_name: "aayushicode::SomeNonexistentAction",
                    context: None,
                    action_arguments: None,
                },
                source: KeybindUpdateTarget {
