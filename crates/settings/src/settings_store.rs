...
pub const LSP_SETTINGS_SCHEMA_URL_PREFIX: &str = "aayushicode://schemas/settings/lsp/";
...
mod tests {
    ...
    fn test_lsp_settings_schema_generation(cx: &mut App) {
        ...
        assert_eq!(
            init_options_ref,
            "aayushicode://schemas/settings/lsp/rust-analyzer/initialization_options"
        );
        ...
        assert_eq!(
            settings_ref,
            "aayushicode://schemas/settings/lsp/rust-analyzer/settings"
        );
    }
