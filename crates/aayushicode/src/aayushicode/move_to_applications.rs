...
impl MoveToApplicationsRequest {
    ...
    async fn prompt(
        ...
        let response = cx
            .prompt(
                PromptLevel::Info,
                "Move AAYKRA to Applications?",
                Some(
                    "AAYKRA is running from a temporary location. Move it to Applications to finish installing it.",
                ),
                &[
                    PromptButton::ok("Yes"),
            ...
            0 => {
                ...
                if let Err(error) = result {
                    cx.prompt(
                        ...
                        "Failed to move AAYKRA to Applications",
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .child(Label::new("Installing AAYKRA…")),
            )
            .child(
                h_flex()
                    .w_full()
                    ...
                    .child(
                        v_flex()
                            .gap_1()
                            .child(Label::new("Moving AAYKRA to Applications"))
                            .child(
                                Label::new("AAYKRA will reopen when installation is complete.")
