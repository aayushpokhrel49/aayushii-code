...
<<<<<<< f0ef8c70a37e946424ce654f8d07267111d3233b:crates/aayushicode/src/aayushicode.rs
=======
        let vim_mode_indicator = cx.new(|cx| vim::ModeIndicator::new(window, cx));
        let pending_keystrokes_indicator =
            cx.new(|cx| which_key::PendingKeystrokesIndicator::new(window, cx));
>>>>>>> 63c8558121bd9f1afbe6db38cd6076711420d1b8:crates/zed/src/zed.rs
...
fn show_software_emulation_warning_if_needed(
    ...
    if specs.is_software_emulated && std::env::var("ZED_ALLOW_EMULATED_GPU").is_err() {
        ...
        let message = format!(
            db::indoc! {r#"
            AAYKRA uses {} for rendering and requires a compatible GPU.
