...
mod reliability;
<<<<<<< f0ef8c70a37e946424ce654f8d07267111d3233b:crates/aayushicode/src/main.rs
mod aayushicode;
=======
mod watcher_debug;
mod zed;
>>>>>>> 63c8558121bd9f1afbe6db38cd6076711420d1b8:crates/zed/src/main.rs
...
fn files_not_created_on_launch(errors: HashMap<io::ErrorKind, Vec<&Path>>) {
    let message = "AAYKRA failed to launch";
...
fn main() {
    ...
    if args.system_specs {
        ...
        println!("AAYKRA System Specs (from CLI):\n{}", system_specs);
        return;
    }
